...
### Метод 1: Прямое выполнение (рекомендуется)
...
### Метод 2: Настройка одной командой
...
# Проверьте установку
python -c "import psutil; print('psutil доступен')"
```
...
### v2.0.0 - Продвинутая защита от обнаружения (текущая)
